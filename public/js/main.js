(function(){try{if(localStorage.getItem('fermaja_theme')==='dark')document.body.classList.add('dark');}catch(e){}})();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function isAdmin() {
    return sessionStorage.getItem('isLoggedIn') === 'true' && !!localStorage.getItem('fermaja_admin_token');
  }
  ...
  function connectSSE() {
    ...
    try {
      const token = localStorage.getItem('fermaja_admin_token') || '';
      const sseUrl = `${window.API_BASE}/api/events?token=${encodeURIComponent(token)}`;
  ...
  function toggleTheme() {
    ...
    try { localStorage.setItem('fermaja_theme', document.body.classList.contains('dark') ? 'dark' : 'light'); } catch (e) {}
